...
## [0.2.8](https://github.com/lelu-auth/lelu/compare/typescript-sdk-v0.2.7...typescript-sdk-v0.2.8) (2026-04-17)
...
* include README.md and LICENSE in npm package (v0.0.13) ([27ee0cf](https://github.com/lelu-auth/lelu/commit/27ee0cf8c1c1f045b6eaf09114349c2c961cc465))
...
* bump TypeScript SDK to v0.2.71-beta and add contributor info ([12a161a](https://github.com/lelu-auth/lelu/commit/12a161a42632674840a6baca2906ad6312577772))
...
* prepare v0.0.14 release with improved README and API key fixes ([a42c309](https://github.com/lelu-auth/lelu/commit/a42c3090b013f816be034d584cdd479a6f831c62))
...
* remove Docker Hub deployment and references ([88cd3d7](https://github.com/lelu-auth/lelu/commit/88cd3d7c4c418da7cb5139dc65a0b973b2f90d6b))
* rename npm package to lelu-agent-auth and update all references ([7fff171](https://github.com/lelu-auth/lelu/commit/7fff171538949b5d49586d48737ede9075c9885a))
...
* update to v0.0.12 with corrected package name in all docs and smaller logo ([9ed979c](https://github.com/lelu-auth/lelu/commit/9ed979cfacfeeb399e6c03d77d6b05c51ce64c3d))
