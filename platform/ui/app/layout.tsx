          ...
          <footer className="border-t border-zinc-200 dark:border-white/[0.08] py-12 mt-20 transition-colors duration-300">
            <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6">
              ...
              <div className="flex gap-6 text-sm text-zinc-500">
                ...
                <a href="https://github.com/Abenezer0923/Lelu" className="hover:text-zinc-800 dark:hover:text-zinc-300 transition-colors">GitHub</a>
