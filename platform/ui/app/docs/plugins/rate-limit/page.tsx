  ...
  return (
    <div className="max-w-3xl">
      <div className="mb-10">
        ...
        <h1 className="text-4xl font-bold text-zinc-900 dark:text-white mb-4 tracking-tight">Rate Limiting Plugin</h1>
...
RATE_LIMIT_ALGORITHM=sliding_window`}</pre>
        ...
        <section>
          <h2 className="text-2xl font-semibold text-zinc-900 dark:text-white mb-4">Per-Action Limits in Rego</h2>
          <p className="text-zinc-600 dark:text-zinc-400 mb-4">You can also define action-level limits directly in your OPA policy. The Engine injects the current request count as <code className="text-sm px-1.5 py-0.5 rounded bg-zinc-100 dark:bg-zinc-800 font-mono">input.rate.count</code> and <code className="text-sm px-1.5 py-0.5 rounded bg-zinc-100 dark:bg-zinc-800 font-mono">input.rate.window_ms</code>.</p>
          <div className="bg-zinc-900 dark:bg-black rounded-xl border border-zinc-800 dark:border-white/10 overflow-hidden">
            <div className="px-4 py-2 border-b border-zinc-800 dark:border-white/10 bg-zinc-950 dark:bg-white/5">
...
deny[msg] {
  ...
  msg := "delete_records: exceeded 10/min rate limit"
        ...
        <section>
          <h2 className="text-2xl font-semibold text-zinc-900 dark:text-white mb-4">HTTP Response on Limit Exceeded</h2>
          <div className="bg-zinc-900 dark:bg-black rounded-xl border border-zinc-800 dark:border-white/10 overflow-hidden">
            <div className="px-4 py-2 border-b border-zinc-800 dark:border-white/10 bg-zinc-950 dark:bg-white/5">
...

{
  ...
  "retry_after_seconds": 42
      ...
      <div className="flex justify-between items-center pt-12 mt-12 border-t border-zinc-200 dark:border-white/10">
        <a href="/docs/plugins/audit-plugin" className="inline-flex items-center gap-2 text-sm font-medium text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-white transition-colors">
