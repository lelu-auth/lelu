  ...
  return (
    <div className="w-full">
      <div className="mb-12">
        <h1
          id="introduction"
          className="text-5xl font-bold text-zinc-900 dark:text-white mb-4 tracking-tight"
        >
          Introduction
        </h1>
        <p className="text-lg text-zinc-500 dark:text-zinc-400 leading-relaxed">
          Lelu is a policy engine for AI-driven systems. It combines Rego-based authorization,
          confidence-aware decisioning, human approval queues, and auditable enforcement so teams
          can ship AI agents without giving up control.
        </p>
      </div>
      ...
      <h2 id="features" className="text-3xl font-bold text-zinc-900 dark:text-white mb-3">
        Features
      </h2>
      <p className="text-base text-zinc-600 dark:text-zinc-400 mb-8 leading-relaxed">
        Lelu includes the core building blocks needed to govern AI actions in production, with
        simple defaults for development and stronger controls for enterprise workloads.
      </p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-16">
        <div className="p-5 rounded-lg border border-zinc-200 dark:border-white/10 bg-white dark:bg-zinc-900/30 hover:border-zinc-300 dark:hover:border-white/20 transition-colors">
          <h3 className="font-semibold text-base text-zinc-900 dark:text-white mb-2">
            Framework Agnostic
          </h3>
          <p className="text-sm text-zinc-600 dark:text-zinc-400 leading-relaxed">
            Works with any AI framework or model provider. Integrate with OpenAI, Anthropic, or
            custom agents.
          </p>
        </div>
        <div className="p-5 rounded-lg border border-zinc-200 dark:border-white/10 bg-white dark:bg-zinc-900/30 hover:border-zinc-300 dark:hover:border-white/20 transition-colors">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-16">
        <a
          ...
          className="group p-6 rounded-lg border border-zinc-200 dark:border-white/10 bg-white dark:bg-zinc-900/30 hover:border-zinc-400 dark:hover:border-white/20 transition-all"
        >
      ...
      <h2 id="why-lelu" className="text-3xl font-bold text-zinc-900 dark:text-white mb-3">
        Why Lelu?
      </h2>
      <p className="text-base text-zinc-600 dark:text-zinc-400 mb-6 leading-relaxed">
        Traditional authorization systems (like RBAC or ABAC) are binary: a user either has
        permission or they don't. But AI agents operate on probabilities. When an AI agent tries to
        execute a trade, delete a database, or send an email, you don't just want to know{" "}
        <em>if</em> it has permission—you want to know <em>how confident</em> it is.
      </p>
      ...
      <div className="bg-zinc-50 dark:bg-zinc-900/30 border border-zinc-200 dark:border-white/10 rounded-lg p-8 mb-16">
        ...
        <div className="space-y-4">
          <div className="flex gap-4">
            ...
            <div>
              <h4 className="font-medium text-base text-zinc-900 dark:text-white mb-1">
                Confidence-Aware Policies
              </h4>
              <p className="text-sm text-zinc-600 dark:text-zinc-400">
                Evaluate authorization requests with built-in confidence thresholds. Write rules
                that adapt to the AI's self-reported certainty.
              </p>
            </div>
          </div>
          <div className="flex gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-zinc-600 dark:text-zinc-400">
                Automatically queue risky or low-confidence actions for human review. The AI pauses
                until a human approves or denies the request.
              </p>
            </div>
          </div>
          <div className="flex gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-zinc-600 dark:text-zinc-400">
                Every decision, confidence score, and human approval is logged immutably for
      ...
      <h2 id="architecture" className="text-3xl font-bold text-zinc-900 dark:text-white mb-6">
        Architecture
      </h2>
        ...
        <div className="flex flex-col md:flex-row items-start justify-between gap-8">
          ...
          <div className="w-full md:w-72 bg-zinc-950 dark:bg-zinc-950/50 rounded border border-zinc-800 dark:border-zinc-800/50 p-4 font-mono text-xs text-zinc-400">
            ...
            <div className="pl-4 mb-1">
              input.action == <span className="text-green-400">"trade"</span>
            </div>
            <div className="pl-4 mb-2">
              input.confidence {">="} <span className="text-orange-400">0.90</span>
            </div>
      ...
      <h2 id="mcp" className="text-3xl font-bold text-zinc-900 dark:text-white mb-3">
        Model Context Protocol
      </h2>
      <p className="text-base text-zinc-600 dark:text-zinc-400 mb-6 leading-relaxed">
        Lelu provides an MCP server so you can use it with any AI model that supports the Model
      ...
      <div className="bg-blue-50 dark:bg-blue-900/10 border border-blue-200 dark:border-blue-800/30 rounded-lg p-4 flex gap-3 mb-8">
        ...
        <p className="text-sm text-blue-900 dark:text-blue-200">
          We provide a first-party MCP, powered by{" "}
          <a
      ...
      <div className="bg-zinc-900 dark:bg-black rounded-xl border border-zinc-800 dark:border-white/10 overflow-hidden mb-8">
        <div className="flex items-center px-4 py-2 border-b border-zinc-800 dark:border-white/10 bg-zinc-950 dark:bg-white/5">
          <div className="flex gap-2">
            <button
              onClick={() => setCliTab("Cursor")}
              className={`px-3 py-1 text-xs rounded transition-colors ${cliTab === "Cursor" ? "bg-zinc-800 text-white font-medium" : "text-zinc-400 hover:text-white hover:bg-zinc-800"}`}
            >
              Cursor
            </button>
            <button
              onClick={() => setCliTab("Claude Code")}
              className={`px-3 py-1 text-xs rounded transition-colors ${cliTab === "Claude Code" ? "bg-zinc-800 text-white font-medium" : "text-zinc-400 hover:text-white hover:bg-zinc-800"}`}
            >
              Claude Code
            </button>
            <button
              onClick={() => setCliTab("Open Code")}
              className={`px-3 py-1 text-xs rounded transition-colors ${cliTab === "Open Code" ? "bg-zinc-800 text-white font-medium" : "text-zinc-400 hover:text-white hover:bg-zinc-800"}`}
            >
              Open Code
            </button>
            <button
              onClick={() => setCliTab("Manual")}
              className={`px-3 py-1 text-xs rounded transition-colors ${cliTab === "Manual" ? "bg-zinc-800 text-white font-medium" : "text-zinc-400 hover:text-white hover:bg-zinc-800"}`}
            >
              Manual
            </button>
          </div>
        ...
        <div className="p-4">
          ...
          <pre className="font-mono text-sm text-zinc-300">{cliCommands[cliTab]}</pre>
        </div>
      </div>
      ...
      <p className="text-zinc-600 dark:text-zinc-400 mb-4">
        Alternatively, you can manually configure the MCP server for each client with the Lelu SSE
        endpoint:
      </p>
      ...
      <div className="bg-zinc-900 dark:bg-black rounded-xl border border-zinc-800 dark:border-white/10 overflow-hidden mb-6">
        <div className="flex items-center px-4 py-2 border-b border-zinc-800 dark:border-white/10 bg-zinc-950 dark:bg-white/5">
          <div className="flex gap-2">
            <button
              onClick={() => setManualTab("Claude Code")}
              className={`px-3 py-1 text-xs rounded transition-colors ${manualTab === "Claude Code" ? "bg-zinc-800 text-white font-medium" : "text-zinc-400 hover:text-white hover:bg-zinc-800"}`}
            >
              Claude Code
            </button>
            <button
              onClick={() => setManualTab("Open Code")}
              className={`px-3 py-1 text-xs rounded transition-colors ${manualTab === "Open Code" ? "bg-zinc-800 text-white font-medium" : "text-zinc-400 hover:text-white hover:bg-zinc-800"}`}
            >
              Open Code
            </button>
            <button
              onClick={() => setManualTab("Manual")}
              className={`px-3 py-1 text-xs rounded transition-colors ${manualTab === "Manual" ? "bg-zinc-800 text-white font-medium" : "text-zinc-400 hover:text-white hover:bg-zinc-800"}`}
            >
              Manual
            </button>
          </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-12">
        <a
          ...
          className="p-4 rounded-xl border border-zinc-200 dark:border-white/10 bg-white dark:bg-zinc-900/50 hover:border-blue-500/50 dark:hover:border-blue-500/50 transition-colors"
        >
      ...
      <div className="flex justify-between items-center pt-8 border-t border-zinc-200 dark:border-white/10 mb-20">
