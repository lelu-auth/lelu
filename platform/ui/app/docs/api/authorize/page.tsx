export default function DocsApiAuthorize() {
  return (
    <div className="max-w-3xl">
      <div className="mb-10">
        ...
        <h1 className="text-4xl font-bold text-zinc-900 dark:text-white mb-4 tracking-tight">POST /api/v1/authorize</h1>
  ...
  "message": "Confidence score too low for requested action."
      ...
      <div className="flex justify-between items-center pt-12 mt-12 border-t border-zinc-200 dark:border-white/10">
        ...
        <a href="/docs/api/queue" className="inline-flex items-center gap-2 text-sm font-medium text-zinc-900 dark:text-white hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
          Next: Queue API
