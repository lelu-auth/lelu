  ...
  return (
    <div className="max-w-3xl">
      ...
      <div className="space-y-12">
        <section>
          <h2 className="text-2xl font-semibold text-zinc-900 dark:text-white mb-4">Register an Agent</h2>
...
// Response (201 Created)
{
  ...
  "created_at": "2023-10-27T10:00:00Z"
        ...
        <section>
          <h2 className="text-2xl font-semibold text-zinc-900 dark:text-white mb-4">Get Agent Reputation</h2>
              ...
              <pre><code>{`// Response (200 OK)
{
  ...
  "denied_requests": 12
      ...
      <div className="flex justify-between items-center pt-12 mt-12 border-t border-zinc-200 dark:border-white/10">
        <a href="/docs/api/queue" className="inline-flex items-center gap-2 text-sm font-medium text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-white transition-colors">
