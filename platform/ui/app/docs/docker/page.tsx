        ...
        <section>
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800/50 rounded-xl p-4 flex gap-3">
            ...
            <div className="text-sm text-blue-800 dark:text-blue-300">
              <p className="mb-2">
                <strong>Multi-Architecture Support:</strong> All images support both linux/amd64 and linux/arm64 architectures.
              </p>
              <p>
...
RISK_REVIEW_THRESHOLD_LOW=0.55`}
          ...
          <div className="mt-4 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800/50 rounded-xl p-4 flex gap-3">
            ...
            <div className="text-sm text-amber-800 dark:text-amber-300">
              <strong>Security:</strong> Generate secure keys using <code className="bg-amber-100 dark:bg-amber-900/50 px-1 rounded font-mono">openssl rand -base64 32</code> and never commit them to version control.
            </div>
          </div>
        </section>
            ...
            <div>
              ...
              <div className="bg-zinc-50 dark:bg-zinc-900/50 border border-zinc-200 dark:border-zinc-800 rounded-lg p-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                  <div>
                    <div className="font-medium text-zinc-900 dark:text-white mb-2">Minimum (Development)</div>
                  ...
                  <div>
                    <div className="font-medium text-zinc-900 dark:text-white mb-2">Recommended (Production)</div>
                    <div className="text-zinc-600 dark:text-zinc-400 space-y-1">
                      <div>• CPU: 4+ cores</div>
                      <div>• RAM: 8GB+</div>
...
docker exec lelu-redis redis-cli BGSAVE`}
        ...
        <section>
          ...
          <div className="space-y-4">
            <div className="border border-zinc-200 dark:border-zinc-800 rounded-lg p-4">
              <h4 className="font-semibold text-zinc-900 dark:text-white mb-2">Services won't start</h4>
              <p className="text-sm text-zinc-600 dark:text-zinc-400 mb-2">
            ...
            <div className="border border-zinc-200 dark:border-zinc-800 rounded-lg p-4">
              <h4 className="font-semibold text-zinc-900 dark:text-white mb-2">Database connection errors</h4>
              <p className="text-sm text-zinc-600 dark:text-zinc-400 mb-2">
            ...
            <div className="border border-zinc-200 dark:border-zinc-800 rounded-lg p-4">
              <h4 className="font-semibold text-zinc-900 dark:text-white mb-2">Permission denied errors</h4>
              <p className="text-sm text-zinc-600 dark:text-zinc-400 mb-2">
      ...
      <div className="flex justify-between items-center pt-12 mt-12 border-t border-zinc-200 dark:border-white/10">
        ...
        <a href="/docs/concepts/architecture" className="inline-flex items-center gap-2 text-sm font-medium text-zinc-900 dark:text-white hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
          Next: Architecture
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
