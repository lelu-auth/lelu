  ...
  return (
    <div className="max-w-3xl">
      ...
      <div className="space-y-12">
        ...
        <section>
          <h2 className="text-2xl font-semibold text-zinc-900 dark:text-white mb-4">Route Handler (App Router)</h2>
          <p className="text-zinc-600 dark:text-zinc-400 mb-6">Gate a server action or route handler before executing a sensitive AI task.</p>
...
NEXT_PUBLIC_PRISM_KEY=your_public_key`}</pre>
      ...
      <div className="flex justify-between items-center pt-12 mt-12 border-t border-zinc-200 dark:border-white/10">
        <a href="/docs/integrations/backend" className="inline-flex items-center gap-2 text-sm font-medium text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-white transition-colors">
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M19 12H5M12 19l-7-7 7-7"/></svg>
          Previous: Backend
        </a>
        <a href="/docs/integrations/react" className="inline-flex items-center gap-2 text-sm font-medium text-zinc-900 dark:text-white hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
          Next: React
