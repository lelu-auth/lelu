...
export function DocsSidebar() {
  ...
  return (
    <aside className="hidden md:block w-64 shrink-0 border-r border-zinc-200/80 dark:border-white/[0.06] bg-white dark:bg-[#09090B]">
      <div
        ref={scrollRef}
        className="docs-sidebar-scroll sticky top-24 md:top-32 h-[calc(100vh-6rem)] md:h-[calc(100vh-8rem)] overflow-y-auto overscroll-contain py-6 px-4 no-scrollbar"
      >
        {/* Logo/Brand */}
        <div className="mb-6">
          <a
