-- Migration: 004_shadow_agents.sql
-- Adds a table to store detected shadow agents for review and analytics.
...
CREATE INDEX IF NOT EXISTS idx_shadow_agents_fingerprint ON shadow_agents(fingerprint_hash);
